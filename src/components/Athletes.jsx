...
import Elena_Ice from "./Elena_Ice.png";
import Jack_Ryder from "./Jack_Ryder.png";
import marcus_drift from "./marcus_drift.png";
import sarah_speed from "./sarah_speed.png";
...
const athletes = [
  {
    ...
    // Default positioning works for Jax
  },
  {
    id: 2,
    name: "ELENA 'ICE' V",
    ...
    // Default positioning works for Elena
  },
  {
    id: 3,
    name: "MARCUS DRIFT",
    ...
    // Marcus is on the right side of the image, so position to the right
    imagePosition: "right",
  },
  {
    id: 4,
    ...
    // Sarah is on the left side of the image, so position to the left
    imagePosition: "left",
  },
];
              ...
              <div className="absolute inset-0 overflow-hidden">
                <img
                  ...
                  className={`w-full h-full object-cover transition-all duration-700 grayscale group-hover:grayscale-0
                    ${athlete.imagePosition === 'right' 
                      ? 'object-[65%_center] md:object-[75%_center] group-hover:scale-110' 
                      : athlete.imagePosition === 'left'
                      ? 'object-[35%_center] md:object-[25%_center] group-hover:scale-110'
